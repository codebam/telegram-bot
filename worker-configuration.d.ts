/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8f78cd405b95fa1336d32320913aaf3d)
// Runtime types generated with workerd@1.20260521.1 2025-06-04 nodejs_compat
interface __BaseEnv_Env {
	...
	COMMIT_SHA: "dev" | "unknown";
	Sandbox: DurableObjectNamespace<import("./src/index").Sandbox>;
	USER_ACCOUNT: DurableObjectNamespace<import("./src/index").UserAccount>;
	STREAM_WORKFLOW: Workflow<Parameters<import("./src/index").BotWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Sandbox" | "UserAccount";
	}
	interface DevEnv {
		CONVERSATION_HISTORY: KVNamespace;
		R2: R2Bucket;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "COMMIT_SHA">> {}
}
